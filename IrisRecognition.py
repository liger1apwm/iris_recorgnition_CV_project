...
def main():
    ...
    print("Amount of features vec on image features train array is: ",len(images_features_train))
    ...
    print("Amount of features vec on image features test array is: ",len(images_features_test))
